  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-left">
        ...
        <h2 className="mt-6 text-xl">Looks like this page took a wrong turn.</h2>
        <p className="meta mt-3">Dada Olawunmi — Frontend Engineer</p>
        <div className="mt-6">
          <Link
            to="/"
            className="meta link-underline text-foreground"
          >
            Back home →
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dada Olawunmi — Frontend Engineer" },
      {
        name: "description",
        content:
